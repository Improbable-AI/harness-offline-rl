...
def setup_wandb(project, entity, configs, **kwargs):
    run = wandb.init(
            project=project,
            entity=entity, #"improbableai_zwh",
            config=configs,
...
def maybe_setup_wandb(mode, project, entity, configs,
...
def get_d3rlpy_args():
    ...
    parser.add_argument('--entity', type=str, default="improbableai_zwh")
